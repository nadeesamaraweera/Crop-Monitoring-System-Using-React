...
export const MainSideBarComponent: React.FC = () => {
    ...
    const sidebarItems = [
        ...
        { href: "/dashboard/crops", Icon: LeafIcon, label: "Crops" },
    ...
    return (
        <>
            ...
            <aside
                className={`fixed top-0 left-0 z-40 w-64 h-screen transition-transform duration-300 ease-in-out bg-gradient-to-b from-green-100 via-green-700 to-green-500 ${
                    isOpen ? "translate-x-0" : "-translate-x-full"
                } sm:translate-x-0 shadow-lg rounded-r-lg`}
                aria-label="Sidebar"
            >
